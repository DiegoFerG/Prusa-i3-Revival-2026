...
| Generation 3 extrusion | E3D Roto + Revo is the preferred 1.75 mm direct-drive direction; PLA quality is primary and ABS/ASA is occasional open-frame use only | [Toolhead target](../../../hardware/generation-3-extrusion-toolhead.md), [Extrusion](../systems/Extrusion.md) |
