...
| Generation 3 enhancements | Prioritised candidate backlog established: software-only functions that reuse frozen hardware are ordered by value/complexity, followed by minimal-hardware or exceptionally high-impact additions for one-by-one study; none are promoted by backlog inclusion. Eddy Duo probing remains the prior promoted exception | [Candidate register](../../../hardware/generation-3-enhancement-candidates.md), [decision DEC-021](../decisions/Decision-Log.md) |
