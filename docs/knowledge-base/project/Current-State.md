...
| Revival Intelligence & Diagnostics | RID is the Generation 3 umbrella for CB2-hosted supervisory intelligence, vision, condition monitoring, maintenance history and diagnostic sensor fusion. The backlog is prioritised by value/complexity; individual entries remain unpromoted unless separately decided | [RID concept](../../../hardware/generation-3-revival-intelligence-diagnostics.md), [RID backlog](../../../hardware/generation-3-enhancement-candidates.md), [Decision Log](../decisions/Decision-Log.md) |
